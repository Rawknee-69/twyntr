...
<div class="flex h-dvh">
	<div class="m-auto flex flex-col items-center gap-2">
		<div class="inline-flex items-center gap-2">
			<img src="logo.svg" alt="Twyntr" class="pointer-events-none h-40 w-40 select-none" />
			<Label class="select-none text-8xl">Twyntr.</Label>
		</div>
				...
				<AlertDialog.Content>
					<AlertDialog.Header>
						...
						<AlertDialog.Description>
							Once you authorise with Discord, you will be redirected back to Twyntr.com
						</AlertDialog.Description>
					</AlertDialog.Header>
				</AlertDialog.Content>
			</AlertDialog.Root>
