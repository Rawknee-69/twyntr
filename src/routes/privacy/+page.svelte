...
<Card class="mx-auto w-full max-w-3xl">
	<CardHeader>
		<CardTitle>Twyntr Privacy Policy</CardTitle>
	...
	<CardContent>
		<Accordion>
			<AccordionItem value="item-1">
				...
				<AccordionContent>
					<p>
						Welcome to Twyntr ("we," "our," or "us"), a social media platform owned and operated by
						REM. This Privacy Policy explains how we collect, use, disclose, and safeguard your
			...
			<AccordionItem value="item-2">
				...
				<AccordionContent>
					...
					<ul class="list-disc space-y-2 pl-5">
						...
						<li>
							<strong>Content Information:</strong> twynts (posts) you create, Images and links you share,
							Reposts you make
						</li>
						<li>
							<strong>Interaction Data:</strong> Likes, Followers and accounts you follow, Views and
							shares of your twynts, Notifications
						</li>
						<li>
			...
			<AccordionItem value="item-9">
				...
				<AccordionContent>
					<p>
						...
						rawknee.6069@gmail.com@gmail.com
					</p>
				</AccordionContent>
			</AccordionItem>
		</Accordion>
